	...
	<div class="contentsection contemplete clear">
		<div class="maincontent clear">
			<div class="about">
				...
				<p><?php echo $result['body']; ?> </p>
				...
				</br><div class="relatedpost clear">
					...
					if($relatedPost){
						...
						?>
					<a href="post.php?id=<?php echo $relatedresult['id']; ?>"><img src="admin/<?php echo $relatedresult['image']; ?>" alt="<?php echo $relatedresult['title']; ?>"/></a>
					<?php 	}
					} else {
